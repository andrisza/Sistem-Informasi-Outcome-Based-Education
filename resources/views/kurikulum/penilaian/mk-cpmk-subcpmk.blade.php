...
@section('header-actions')
    @include('layouts._export-button', ['route' => route('kurikulum.penilaian.mk-cpmk-subcpmk.export', $kurikulum)])
@endsection
...
function closeAllModals() {
    ['modal-overlay','modal-add-cpmk','modal-edit-cpmk','modal-add-subcpmk']
