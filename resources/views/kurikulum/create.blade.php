...
<form method="POST" action="{{ route('kurikulum.store') }}" class="max-w-3xl">
    @csrf
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nama_kurikulum" value="{{ old('nama_kurikulum') }}"
                           ...
                           placeholder="cth: Kurikulum Program Studi Informatika 2024">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="visi" rows="3"
                              ...
                              placeholder="Visi program studi...">{{ old('visi') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="misi" rows="3"
                              class="w-full border border-gray-300 rounded-lg px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                              placeholder="Misi program studi...">{{ old('misi') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="tujuan" rows="3"
                              class="w-full border border-gray-300 rounded-lg px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                              placeholder="Tujuan program studi...">{{ old('tujuan') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="sasaran" rows="3"
                              class="w-full border border-gray-300 rounded-lg px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
                              placeholder="Sasaran program studi...">{{ old('sasaran') }}</textarea>
                </div>
