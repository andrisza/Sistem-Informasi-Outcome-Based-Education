...
@section('title', 'Edit BK – ' . $bahanKajian->kode_bk)
@section('header', 'Edit Bahan Kajian')
...
@section('breadcrumb')
    ...
    <span class="mx-1 text-gray-300">/</span>
    <span class="text-gray-700 font-medium">{{ $bahanKajian->kode_bk }}</span>
@endsection

@section('content')

<form method="POST" action="{{ route('kurikulum.bahan-kajian.update', [$kurikulum, $bahanKajian]) }}" class="max-w-2xl">
    @csrf @method('PUT')
