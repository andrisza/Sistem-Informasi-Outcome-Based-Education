...
@section('header', 'Tambah Sub-CPMK')
...
<form method="POST" action="{{ route('kurikulum.mata-kuliah.cpmk.sub-cpmk.store', [$kurikulum, $mataKuliah, $cpmk]) }}" class="max-w-2xl">
    @csrf

    <div class="bg-blue-50 border border-blue-100 rounded-xl px-5 py-3 mb-4 text-sm">
        <span class="text-blue-600 font-semibold">CPMK:</span>
        <span class="text-blue-800 ml-1">{{ $cpmk->kode_cpmk }} – {{ Str::limit($cpmk->deskripsi, 80) }}</span>
        <span class="ml-4 text-xs text-blue-500">Bobot terpakai: {{ number_format($totalBobot, 1) }}% / 100%</span>
    </div>
        ...
        <div class="px-6 py-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="kode_sub_cpmk" value="{{ old('kode_sub_cpmk') }}"
            ...
            <div>
                ...
                <textarea name="deskripsi" rows="3"
                          ...
                          placeholder="Deskripsi sub-CPMK...">{{ old('deskripsi') }}</textarea>
            ...
            <div>
                ...
                <input type="number" name="bobot" value="{{ old('bobot') }}" min="0" max="100" step="0.1"
                ...
                <p class="text-xs text-gray-400 mt-1">Sisa bobot: {{ number_format(100 - $totalBobot, 1) }}%</p>
            </div>
