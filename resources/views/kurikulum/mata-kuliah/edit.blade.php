    ...
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm divide-y divide-gray-50">
        <div class="px-6 py-5 space-y-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <select name="kategori_mk"
                        ...
                        @if ($mataKuliah->kategori_mk && !$kategoriOptions->contains($mataKuliah->kategori_mk))
                            <option value="{{ $mataKuliah->kategori_mk }}" selected>{{ $mataKuliah->kategori_mk }}</option>
                        @endif
                    </select>
            ...
            <div>
                ...
                <input type="text" name="kode_prasyarat" value="{{ old('kode_prasyarat', $mataKuliah->kode_prasyarat) }}"
