...
@section('header', 'Tambah Semester Akademik')
...
<div class="max-w-xl">
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
        <form method="POST" action="{{ route('kaprodi.semester-akademik.store') }}" class="space-y-5">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="text" name="tahun_akademik" value="{{ old('tahun_akademik') }}" required
                ...
                <div>
                    ...
                    <select name="jenis" required
                        ...
                        <option value="Gasal"  {{ old('jenis') === 'Gasal'  ? 'selected' : '' }}>Gasal</option>
